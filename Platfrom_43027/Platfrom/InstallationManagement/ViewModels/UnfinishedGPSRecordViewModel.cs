...
{
    [ExportAsViewModel(InstallationName.UnfinishedGPSRecordVm)]
    public class UnfinishedGPSRecordViewModel : ListViewModel<InstallationInfo>
    {
        #region
        ...
        private void PageSizeChenged()
        {
            ...
            deviceInstallServiceClient.GetInstallationInProgressExAsync(ApplicationContext.Instance.AuthenticationInfo.ClientID, CarNumber, GPSSn, Installer, InstallstationId, BeginDate, EndDate, pageinfo);
        ...
        private void GetInfoByPageIndex()
        {
            ...
            deviceInstallServiceClient.GetGPSInstallationInProgressExAsync(CarNumber, GPSSn, Installer, InstallstationId, BeginDate, EndDate, pageinfo);
        }
        ...
        public UnfinishedGPSRecordViewModel()
        {
            try
            {
            ...
            deviceInstallServiceClient.GetGPSInstallationInProgressExCompleted += deviceInstallServiceClient_GetGPSInstallationInProgressExCompleted;
        ...
        private void delete()
        {
            var result = MessageBoxHelper.ShowDialog(ApplicationContext.Instance.StringResourceReader.GetString("Tip"), ApplicationContext.Instance.StringResourceReader.GetString("ID_INSTALL_IfDelete"), MessageDialogButton.OkAndCancel);
            ...
            //    ApplicationContext.Instance.MessageClient.RemoveInstallGPS(CurrentInstallRecord.DeviceCoreId);
            //}
        }
        ...
        void deviceInstallServiceClient_GetGPSInstallationInProgressExCompleted(object sender, GetGPSInstallationInProgressExCompletedEventArgs e)
        {
            try
            {
                ...
                {
                    this.CurrentInstallRecord = SuiteModels_Imps[0];
                }
                PageChanged = false;
            }
            catch (Exception ex)
        ...
        private void View()
        {
            try
            {
                ...
                {
                    case 2:
                        view = InstallationName.InstallGPSCheckV;
                        break;
                    case 3:
                        view = InstallationName.InstallVehcileGPSCheckV;
                        break;
                    case 4:
                        view = InstallationName.InstallGPSConfirmV;
                        break;
                    default:
                        view = InstallationName.InstallGPSVehicleCheckV;
                        break;
                }
