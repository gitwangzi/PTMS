...
{
    [ExportAsViewModel(ReportName.ExceptionSuiteRptVM)]
    public class ExceptionSuiteRptVM : BaseReportViewModel
    {
        public string ReportTitle { get { return ApplicationContext.Instance.StringResourceReader.GetString("Rpt_ExceptionSuite_Title"); } }

        public ExceptionSuiteRptVM() :
            base("Gsafety.PTMS.Reports.ExceptionSuiteRpt, Reports, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null")
        {
