...
namespace Gsafety.PTMS.ReportManager.ViewModels
{
    ...
    public class BusinessAlertBaseViewModel : BaseReportViewModel
    {
        public string ReportTitle { get { return ApplicationContext.Instance.StringResourceReader.GetString("Rpt_Alarm_Title"); } }

        public BusinessAlertBaseViewModel() :
            base("Gsafety.PTMS.Reports.BusinessAlertReport, Reports, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null")
        {
