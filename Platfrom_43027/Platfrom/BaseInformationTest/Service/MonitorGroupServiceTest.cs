...
namespace Gsafety.PTMS.Message.Test
{
	...
	/// </summary>
	[TestClass]
	public class MonitorGroupServiceTest
	{
		...
		public void TestStringForAllEmpty()
		{
			...
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID=null;
			monitorgroup.GroupName=null;
			monitorgroup.Note=null;
			monitorgroup.CreateUser=null;
			SingleMessage<bool> ret = service.AddMonitorGroup(monitorgroup);
		...
		public void TestStringForAllowEmpty()
		{
			...
			monitorgroup.ID=builder.ToString();
			builder.Length=0;
		...
		public void TestStringForMaxLength_Chinese()
		{
			...
			monitorgroup.GroupName=builder.ToString();
			builder.Length=0;
			...
			monitorgroup.Note=builder.ToString();
			builder.Length=0;
			...
			monitorgroup.CreateUser=builder.ToString();
			builder.Length=0;
		...
		/// </summary>
		[TestMethod]
		public void TestGroupNameStringForOverLength_Chinese()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			StringBuilder builder = new StringBuilder();
		...
		/// </summary>
		[TestMethod]
		public void TestGroupNameStringForMaxLength_Spanish()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			StringBuilder builder = new StringBuilder();
		...
		/// </summary>
		[TestMethod]
		public void TestGroupNameStringForMaxLength_English()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			StringBuilder builder = new StringBuilder();
		...
		/// </summary>
		[TestMethod]
		public void TestCreateUserStringForOverLength_Chinese()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			StringBuilder builder = new StringBuilder();
		...
		/// </summary>
		[TestMethod]
		public void TestCreateUserStringForMaxLength_Spanish()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			StringBuilder builder = new StringBuilder();
		...
		/// </summary>
		[TestMethod]
		public void TestCreateUserStringForMaxLength_English()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			StringBuilder builder = new StringBuilder();
...
builder.Append(";");
		...
		/// </summary>
		[TestMethod]
		public void TestStringForSpecialCharacterTest()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			StringBuilder builder = new StringBuilder();
...
builder.Append("\"");
		...
		public void TestStringForSpecialCharacterSelect()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="select";

			monitorgroup.GroupName="select";

			monitorgroup.Note="select";

			monitorgroup.CreateUser="select";
		...
		public void TestStringForSpecialCharacterUpdate()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="update";

			monitorgroup.GroupName="update";

			monitorgroup.Note="update";

			monitorgroup.CreateUser="update";
		...
		public void TestStringForSpecialCharacterDelete()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="delete";

			monitorgroup.GroupName="delete";

			monitorgroup.Note="delete";

			monitorgroup.CreateUser="delete";
		...
		/// </summary>
		[TestMethod]
		public void TestGroupNameDateTimeForNull()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="";
		...
		/// </summary>
		[TestMethod]
		public void TestCreateUserDateTimeForNull()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="";
		...
		/// </summary>
		[TestMethod]
		public void TestGroupNameDateTimeForIncomplete()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="";
		...
		/// </summary>
		[TestMethod]
		public void TestCreateUserDateTimeForIncomplete()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="";
		...
		/// </summary>
		[TestMethod]
		public void TestGroupNameDateTimeForFormatError()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="";
		...
		/// </summary>
		[TestMethod]
		public void TestCreateUserDateTimeForFormatError()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="";
		...
		/// </summary>
		[TestMethod]
		public void TestGroupNameDateTimeForMax()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="";
		...
		/// </summary>
		[TestMethod]
		public void TestCreateUserDateTimeForMax()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="";
		...
		/// </summary>
		[TestMethod]
		public void TestGroupNameDateTimeForMin()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="";
		...
		/// </summary>
		[TestMethod]
		public void TestCreateUserDateTimeForMin()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
			monitorgroup.ID="";
		...
		public void TestIDUpdateNotExist()
		{
			MonitorGroup monitorgroup = new MonitorGroup();
			MonitorGroupService service = new MonitorGroupService();
		    monitorgroup.ID = DateTime.MinValue.ToLongDateString();
			var ret = service.GetMonitorGroups(monitorgroup.ID);
			//Assert.IsFalse(ret.IsSuccess);
		}
