...
namespace Gsafety.Ant.BaseInformation.ViewModels
{
    ...
    public class SafeDeviceInfoViewModel : UploadAndExportViewModelBase<DevSuite>
    {
        ...
        public IActionCommand BtnCopyCommand { get; protected set; }

        public IActionCommand BtnPartCopyCommand { get; set; }
        ...
        public SafeDeviceInfoViewModel()
        {
            try
            {
                ...
                BtnCopyCommand = new ActionCommand<object>(obj => Copy());
                BtnPartCopyCommand = new ActionCommand<object>(obj => CopyPart());
        ...
        {
            SafeDevicePartDetailWindow window = new SafeDevicePartDetailWindow("", new System.Collections.Generic.Dictionary<string, object>() { { "action", "copy" }, { "model", CurrentPart } });
            window.Show();
        }
