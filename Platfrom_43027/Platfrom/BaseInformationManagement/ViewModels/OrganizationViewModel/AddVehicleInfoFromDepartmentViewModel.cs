...
namespace Gsafety.Ant.BaseInformation.ViewModels.OrganizationViewModel
{
    ...
    public class AddVehicleInfoFromDepartmentViewModel : DetailViewModel<Gsafety.PTMS.ServiceReference.VehicleService.Vehicle>
    {
        ...
        public string Ficha
        {
            ...
            set
            {
                ficha = value == null ? null : value.Trim();
                ValidateFicha(ExtractPropertyName(() => Ficha), ficha);
                RaisePropertyChanged(() => this.Ficha);
            }
        }
        ...
        public DateTime? ProductDate
        {
            ...
            set
            {
                if (value.HasValue)
                {
                    productDate = value.Value.ToUniversalTime();
                    ValidateProductDate(ExtractPropertyName(() => ProductDate), (DateTime)productDate);
                }
            }
        }
            ...
            try
            {
                ...
                switch (action)
                {
                    ...
                    case "copy":
                        ...
                        IsVehicleReadOnly = false;
                        InitialModel = viewParameters["data"] as Gsafety.PTMS.ServiceReference.VehicleService.Vehicle;
                        dataOperateType = "copy";
                        InstallStatus = InstallStatusType.UnInstall;
                        ViewVehicle();
                        Title = ApplicationContext.Instance.StringResourceReader.GetString("BaseInfoCopy");
                        break;
        ...
        private void ViewVehicle()
        {
            try
            {
                ...
                this.ProductDate = InitialModel.ProductDate;
        ...
        protected override void OnCommitted()
        {
            ...
            try
            {
                ...
                v.Ficha = this.Ficha;
                v.ProductDate = this.ProductDate;        
                ...
                vehicle.Ficha = this.Ficha;
                vehicle.ProductDate = this.ProductDate;
        ...
        private void ValidateFicha(string prop,string value)
        {
            ValidateRequire(prop, value);
        }

        private void ValidateProductDate(string prop, DateTime value)
        {
            ClearErrors(prop);
            if (value > DateTime.Now.ToUniversalTime())
            {
                SetError(prop, ApplicationContext.Instance.StringResourceReader.GetString("ProductDateError"));
            }
        }
