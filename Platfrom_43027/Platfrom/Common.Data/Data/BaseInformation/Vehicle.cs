...
namespace Gsafety.PTMS.Common.Data
{
    ...
    public class Vehicle
    {
        ...
        public override string ToString()
        {
            ...
            if (!string.IsNullOrEmpty(Convert.ToString(Ficha)))
            {
                builder.AppendLine("Ficha:" + Ficha.ToString());
            }
            if (!string.IsNullOrEmpty(Convert.ToString(ProductDate)))
            {
                builder.AppendLine("ProductDate:" + ProductDate.ToString());
            }
