...
/////======================================================================
/////                   Guid: deea0601-3e6f-4c54-8c11-deaff2f91c73      
...
/////    Project Description:    
/////             Class Name: OpenOrCloseDoorAbnormalAlert
/////          Class Version: v1.0.0.0
/////            Create Time: 8/28/2013 2:01:43 PM
/////      Class Description:  
/////======================================================================
/////          Modified Time: 8/28/2013 2:01:43 PM
/////            Modified by:
...
{
    /// <summary>
    /// Open Or Close Door Abnormal Alert
    /// </summary>
    [Serializable]
    [DataContract]
    public class OpenOrCloseDoorAbnormalAlert : AlertBaseModel
    {

        /// <summary>
        /// 1:front door；2:back door；3:middle door。
        /// </summary>
        [DataMember]
        public string DoorType { get; set; }

        /// <summary>
        /// 0：close door；1：open door。
        /// </summary>
        [DataMember]
        public string DoorOperation { get; set; }

        /// <summary>
        /// the car speed when the door open
        /// </summary>
        [DataMember]
        public string TriggerSpeed { get; set; }

        /// <summary>
        /// the limit speed for open or close door
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// OpenOrClose Door AbnormalAlert Alert
        /// </summary>
        ...
        /// </param>
        public OpenOrCloseDoorAbnormalAlert(string str)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(str))
                {
                    ...
                    {
                        if (alertArray[3].Trim().ToUpper().Equals("V83"))
                        {
                            ...
                            //AlertType
                            this.AlertType = (short)BusinessAlertType.AbnormalDoor;
                            ...
                            //DoorType
                            this.DoorType = alertArray[38];
                            //DoorOperation
                            this.DoorOperation = alertArray[39];
                            //TriggerSpeed
                            this.TriggerSpeed = alertArray[40];
                            //LimitSpeed
                            this.LimitSpeed = alertArray[41];
                            //TimeZone
                            this.TimeZone = alertArray[42];
                        }
                    }
                }
            }
            ...
            {
                Console.WriteLine(DateTime.Now + "--Gsafety.Ant.Alert.Contract.Data.OpenOrCloseDoorAbnormalAlert.OpenOrCloseDoorAbnormalAlert(string str) --" + ex.ToString());
            }
        }
