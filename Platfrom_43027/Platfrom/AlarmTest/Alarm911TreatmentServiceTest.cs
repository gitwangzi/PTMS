...
using Gsafety.PTMS.Alarm.Service;
...
namespace Gsafety.PTMS.Monitor.Test
{
	...
	/// </summary>
	[TestClass]
	public class Alarm911TreatmentServiceTest
	{
        ...
        private const string spanishcharacter = "qwértyúíopasdghjklñ´zxcvbnm?¿¡!1234567890 \"";
		...
		{
			Alarm911Treatment alarm911treatment = new Alarm911Treatment();
		    VehicleAlarmService  service = new VehicleAlarmService();
			var ret = service.GetAlarm911Treatments(null);
		...
		public void TestStringForMaxLength_Spanish()
		{
			...
			alarm911treatment.AlarmId=builder.ToString();
			builder.Length=0;
			var ret = service.GetAlarm911Treatments(alarm911treatment.AlarmId);
			//Assert.IsFalse(ret.IsSuccess);
		}
		...
		/// </summary>
		[TestMethod]
		public void TestAlarmIdStringForMaxLength_Spanish()
		{
			Alarm911Treatment alarm911treatment = new Alarm911Treatment();
            VehicleAlarmService service = new VehicleAlarmService();
			StringBuilder builder = new StringBuilder();
		...
		/// </summary>
		[TestMethod]
		public void TestAlarmIdStringForMaxLength_English()
		{
			Alarm911Treatment alarm911treatment = new Alarm911Treatment();
            VehicleAlarmService service = new VehicleAlarmService();
			StringBuilder builder = new StringBuilder();
