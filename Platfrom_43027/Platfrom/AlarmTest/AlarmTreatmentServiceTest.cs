...
namespace Gsafety.PTMS.Monitor.Test
{
	...
	/// </summary>
	[TestClass]
	public class AlarmTreatmentServiceTest
	{
		...
		{
			AlarmTreatment alarmtreatment = new AlarmTreatment();
			VehicleAlarmService service = new VehicleAlarmService();
			alarmtreatment.DisposeStaff=null;
			alarmtreatment.Content=null;
			var ret = service.GetAlarmTreatments(null);
		...
		public void TestIdStringForMaxLength_Spanish()
		{
            ...
            alarmtreatment.AlarmId = builder.ToString();
			builder.Length=0;
			var ret = service.GetAlarmTreatments(alarmtreatment.AlarmId);
			//Assert.IsFalse(ret.IsSuccess);
		}
