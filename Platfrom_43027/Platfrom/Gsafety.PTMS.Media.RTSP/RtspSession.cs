...
namespace Gsafety.PTMS.Media.RTSP
{
    ...
    internal class RtspSession : SuppressedFinalizerDisposable
    {
        ...
        public SessionDescription SessionDescription { get; protected set; }
        ...
        public Gsafety.PTMS.Media.RTSP.RTP.RtpClient.TransportContext Context { get; internal protected set; }
        ...
        {
            get { return Timeout <= TimeSpanExtensions.InfiniteTimeSpan ? TimeSpanExtensions.InfiniteTimeSpan : Timeout - (System.DateTime.UtcNow - (LastResponse.Transferred ?? LastResponse.Created)); }
        }
                ...
                if (headerPartsLength > 0)
                {
                        ...
                        value[0] != SessionId[0])
                    {
                        ...
                        if (sessionHeaderParts.Length > 1)
                        {
                            ...
                            {
                                int timeoutStart = 1 + timeoutPart.IndexOf(Gsafety.PTMS.Media.RTSP.Sdp.SessionDescription.EqualsSign);
