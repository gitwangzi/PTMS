...
namespace Gsafety.PTMS.Maintain.Contract
{
    ...
    public interface IMaintainApplication
    {
        ...
        [OperationContract]
        SingleMessage<MaintainApplication> GetMaintainApplication(string ID);
        /// <summary>
        /// 获取维修申请列表
        /// </summary>
        /// <returns>获取维修申请</returns>
        [OperationContract]
        MultiMessage<MaintainApplication> GetMaintainApplicationList(string clientID, int state, string applicant, string vehicleID, string application, int pageIndex, int pageSize);
        
        [OperationContract]
        MultiMessage<InstallStation> GetInstallStationList(string clientID);
    }
}
