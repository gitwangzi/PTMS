...
/////    Project Description:    
/////             Class Name: GPSLonChangeDisplayConvert
...
{
    public class GPSLonChangeDisplayConvert : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            try
            {
                if (value == null || string.IsNullOrEmpty(value.ToString()))
                    return "";
                object toResult = LonStrToDouble(value);
        ...
        {
            return LonStrToDouble(value);
        }

        private  object LonStrToDouble(object value)
        {
