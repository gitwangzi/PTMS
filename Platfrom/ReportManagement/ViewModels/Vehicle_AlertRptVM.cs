...
{
    [ExportAsViewModel(ReportName.Vehicle_AlertRptVM)]
    public class Vehicle_AlertRptVM : BaseReportViewModel
    {
        ...
        public string ReportTitle { get { return ApplicationContext.Instance.StringResourceReader.GetString("Rpt_Vehicle_Alert_Title"); } }

        public Vehicle_AlertRptVM() :
            base("Gsafety.PTMS.Reports.VehicleAlertRpt, Reports, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null")
        {
