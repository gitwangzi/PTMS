...
{
    [ExportAsViewModel(ReportName.VehicleOnTimeRptVM)]
    public class VehicleOnTimeRptVM : BaseReportViewModel
    {
        public string ReportTitle { get { return ApplicationContext.Instance.StringResourceReader.GetString("Rpt_Vehicle_OnTime_Title"); } }

        public VehicleOnTimeRptVM() :
            base("Gsafety.PTMS.Reports.VehicleOnTimeRpt, Reports, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null")
        {
