...
{
    [ExportAsViewModel(InstallationName.InstalledGPSRecordVm)]
    public class InstalledGPSRecordViewModel : ListViewModel<InstallationInfo>
    {
        ...
        private void PageSizeChenged()
        {
            try
            {
                ...
                deviceInstallServiceClient.GetGPSInstallationFinishedAsync(CarNumber, SuiteId, Installer, stations, BeginDate, EndDate, pageinfo);
            }
            catch (Exception ex)
            {
        ...
        private DeviceInstallServiceClient InitClient()
        {
            ...
            deviceInstallServiceClient.GetGPSInstallationFinishedCompleted += deviceInstallServiceClient_GetGPSInstallationFinishedCompleted;

            return deviceInstallServiceClient;
        }

        public InstalledGPSRecordViewModel()
        {
            try
            {
        ...
        void deviceInstallServiceClient_GetGPSInstallationFinishedCompleted(object sender, GetGPSInstallationFinishedCompletedEventArgs e)
        {
            try
            {
                if (e.Error == null)
