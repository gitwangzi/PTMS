...
{
    public partial class VehicleOrganizationNavigationer : Page
    {
        public VehicleOrganizationNavigationer()
        {
            InitializeComponent();
        ...
        /// </summary>
        [Import]
        public VehicleOrganizationNavigationContainer NavContainer { get; set; }
