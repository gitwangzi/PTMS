...
{
    public partial class VehicleDepartmentNavigationer : Page
    {
        public VehicleDepartmentNavigationer()
        {
            InitializeComponent();
        ...
        /// </summary>
        [Import]
        public VehicleDepartmentNavigationContainer NavContainer { get; set; }
