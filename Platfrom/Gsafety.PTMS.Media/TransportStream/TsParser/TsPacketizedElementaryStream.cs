...
#if DEBUG
            //LoggerInstance.Debug("Create PES Packet({0}) Index {1} Length {2} Time {3} ({4}s) {5}", pes.PacketId, pes.Index, pes.Length, pes.PresentationTimestamp, pes.PresentationTimestamp.TotalSeconds, pes.BufferEntry);
#endif
