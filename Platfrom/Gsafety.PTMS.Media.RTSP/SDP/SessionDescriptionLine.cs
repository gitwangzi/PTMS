using Gsafety.PTMS.Media.RTSP.Common.Extensions.Object;
using System;
...
namespace Gsafety.PTMS.Media.RTSP.Sdp
{
    ...
    public class SessionDescriptionLine : IEnumerable<String>//, IUpdateable
    {
        ...
        public SessionDescriptionLine(string line, string seperator = null, int partCount = -1)
        {
            ...
            if (line.Length < 2
                ||
                line[1] != SessionDescription.EqualsSign) Gsafety.PTMS.Media.RTSP.Common.TaggedExceptionExtensions.RaiseTaggedException(this, "Invalid SessionDescriptionLine: \"" + line + "\"");
        ...
        public override bool Equals(object obj)
        {
            ...
            return other.Encoding == m_Encoding
                ...
                string.Compare(ToString(), other.ToString(), StringComparison.CurrentCultureIgnoreCase) == 0;
        }
