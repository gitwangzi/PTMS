    ...
    public sealed class RFC3550
    {
        ...
        public static int Random32(int type = 0)
        {
            ...
            byte[] structure = Binary.GetBytes(type).//int     type;
                ...
                Concat(Binary.GetBytes(System.Threading.Thread.CurrentThread.ManagedThreadId)).//pid_t   pid;
                Concat(Guid.NewGuid().ToByteArray()).//gid_t   gid;
               ToArray();//struct  utsname name;
        ...
        public static int RtcpValidValue(int version, int payloadType = SendersReport.PayloadType)
        {
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public static bool IsValidRtcpHeader(RtcpHeader header, int version = 2) { return (header.First16Bits & RtcpValidMask) == RtcpValidValue(version); }
        ...
        public static IEnumerable<byte> CreatePadding(int amount) //int? codeAmount
        {
            ...
            if (amount > byte.MaxValue) Binary.CreateOverflowException("amount", amount, byte.MinValue.ToString(), byte.MaxValue.ToString());
   ...
   +=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+
            */
            ...
            public static byte PackOctet(int version, bool padding, bool extension, byte remainingBits = 0)
            {
                ...
                //if (Binary.IsLittleEndian) remainingBits = Binary.ReverseU8((byte)remainingBits);
            ...
            /// </summary>
            internal readonly MemorySegment m_Memory;
            ...
            public int Version
            {
                ...
                get { return First8Bits >> 6; } //Binary.IsLittleEndian ? First8Bits >> 6 : First8Bits << 6; }
                //get { return (int)Binary.ReadBitsMSB(m_Memory.Array, Binary.BitsToBytes(m_Memory.Offset), 2); }
                [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            ...
            public bool Extension
            {
                ...
                //get { return First8Bits > 0 && (Binary.ReadBitsWithShift(First8Bits, 3, 7, Binary.IsBigEndian) & ExtensionMask) > 0; }
            ...
            public int RtcpBlockCount
            {
                ...
                get { return (byte)(First8Bits & Binary.FiveBitMaxValue); } // Binary.IsLittleEndian ? Binary.ReverseU8((byte)(First8Bits << 3)) : Binary.ReverseU8((byte)(First8Bits >> 3)); }
                [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]

                //get { return (int)Binary.ReadBitsMSB(m_Memory.Array, Binary.BytesToBits(m_Memory.Offset) + 3, 5); }
                set
                {
                    ...
                    //Get a unsigned copy to prevent two checks, the value is only 5 bits and must be aligned to this boundary in the octet
                    byte unsigned = (byte)value; //Binary.IsLittleEndian ? (byte)(Binary.ReverseU8((byte)(value)) >> 3) : (byte)(value << 3);
            ...
            public int RtpContributingSourceCount
            {
                ...
                //get { return Binary.ReverseU8((byte)Binary.ReadBitsWithShift(First8Bits, 0, 4, Binary.IsLittleEndian)); }
                //get { return Binary.IsLittleEndian ? Binary.ReverseU8((byte)(First8Bits << 4)) : First8Bits << 4;} // Binary.ReverseU8((byte)(First8Bits >> 4)); }
                get { return (First8Bits & Binary.FourBitMaxValue); }
                //get { return (int)Binary.ReadBitsMSB(m_Memory.Array, Binary.BytesToBits(m_Memory.Offset) + 4, 4); }
                [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
                ...
                internal set
                {
                    ...
                    //byte unsigned = Binary.IsLittleEndian ? (byte)(Binary.ReverseU8((byte)(value)) >> 4) : (byte)(value << 4);
            ...
            public int RtpPayloadType
            {
                ...
                get { return Last8Bits & Binary.SevenBitMaxValue; }
                //get { return (int)Binary.ReadBitsMSB(m_Memory.Array, Binary.BytesToBits(m_Memory.Offset + 1) + 1, 7); }
                [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            ...
            /// <param name="shouldDispose">indicates if memory will disposed when <see cref="Dispose"/> is called
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            public CommonHeaderBits(MemorySegment memory, bool shouldDispose = true) //, int additionalOffset = 0)
                : base(shouldDispose)
            {
                ...
                m_Memory = new MemorySegment(memory.Array, memory.Offset /*+ additionalOffset*/, CommonHeaderBits.Size);
            }
            ...
            public IEnumerator<byte> GetEnumerator()
            {
                ...
                MemorySegment segment = m_Memory;
            ...
            public int CopyTo(byte[] dest, int offset)
            {
                ...
                MemorySegmentExtensions.CopyTo(m_Memory, dest, offset);
            ...
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            public static implicit operator short(CommonHeaderBits bits) { return Binary.Read16(bits, 0, Binary.IsLittleEndian); }
        ...
        /*, IReadOnlyCollection<uint> */ //Only needed if modifications to a SourceList are allowed at run time.
        {
            ...
            /// </summary>
            public const int MaxItems = Binary.FiveBitMaxValue;
            ...
            /// </summary>
            readonly MemorySegment m_Binary = MemorySegment.Empty;
            ...
            public SourceList(IEnumerable<uint> sources, int start = 0, bool shouldDispose = true)
                : base(shouldDispose)
            {
                IEnumerable<byte> binary = MemorySegment.EmptyBytes;

                foreach (var ssrc in sources.Skip(start))
                {
                    binary = binary.Concat(Binary.GetBytes(ssrc, Binary.IsLittleEndian)).ToArray();

                    //Increment for the added value and determine if the maximum is reached.
                    if (++m_SourceCount >= SourceList.MaxItems) break;
                }

                m_Binary = new MemorySegment(binary.ToArray(), 0, m_SourceCount * Binary.BytesPerInteger);
            }
            ...
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            public SourceList(Gsafety.PTMS.Media.RTSP.RTP.RtpHeader header, byte[] buffer, int offset = 0, bool shouldDispose = true)
                : base(shouldDispose)
            {
                ...
                if (m_SourceCount > 0)
                {
                    ...
                    m_Binary = new MemorySegment(buffer, offset, Binary.Clamp(buffer.Length - offset, 0, m_SourceCount * Binary.BytesPerInteger));
                }
            }
            ...
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            public SourceList(Gsafety.PTMS.Media.RTSP.RTP.RtpPacket packet, bool shouldDispose = true)
            ...
            public SourceList(int sourceCount, bool shouldDispose = true)
                : base(shouldDispose)
            {
                if (0 == (m_SourceCount = Binary.Min(SourceList.MaxItems, sourceCount))) return;

                m_Binary = new MemorySegment(Binary.BytesPerInteger * m_SourceCount);
                ...
                : base(shouldDispose)
            {
                ...
                m_Binary = m_SourceCount == 1 ? goodbyeReport.Header.GetSendersSynchronizationSourceIdentifierSegment() : new MemorySegment(goodbyeReport.Payload.Array,
            ...
            //    Binary.WriteNetwork32(m_Binary.Array, m_CurrentOffset, Binary.IsBigEndian, m_CurrentSource);
            ...
            public bool MoveNext()
            {
                ...
                if (m_Read <= m_SourceCount && m_CurrentOffset + Binary.BytesPerInteger <= m_Binary.Array.Length)
                {
                    ...
                    m_CurrentSource = Binary.ReadU32(m_Binary.Array, ref m_CurrentOffset, Binary.IsLittleEndian);
            ...
            public bool TryCopyTo(byte[] other, int offset)
            {
                try
                {
                    ...
                    //Array.Copy(m_Binary.Array, m_Binary.Offset, other, offset, Binary.Min(m_SourceCount * Binary.BytesPerInteger, m_Binary.Count));

                    MemorySegmentExtensions.CopyTo(m_Binary, other, offset);
