...
namespace Gsafety.PTMS.Manager.Views.SystemLog
{
    ...
    /// 报警处理日志View
    /// </summary>
    [ExportAsView(ManagerName.AlarmDisposedLogV, Category = ManagerName.CategoryName, MenuName = ManagerName.UserMangeMenuName)]
    [ExportViewToRegion(ManagerName.AlarmDisposedLogV, ManagerName.ManagerContainer)]
