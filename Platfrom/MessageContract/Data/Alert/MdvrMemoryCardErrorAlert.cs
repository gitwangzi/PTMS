...
/////======================================================================
/////                   Guid: de3dce52-53c2-46d7-893b-7e0f029a2a94      
...
/////    Project Description:    
/////             Class Name: MdvrMemoryCardErrorAlert
/////          Class Version: v1.0.0.0
/////            Create Time: 8/26/2013 1:24:40 PM
/////      Class Description:  
/////======================================================================
/////          Modified Time: 8/26/2013 1:24:40 PM
/////            Modified by:
...
{
    /// <summary>
    /// Mdvr Memory CardError Alert
    /// </summary>
    [Serializable]
    [DataContract]
    public class MdvrMemoryCardErrorAlert : AlertBaseModel
    {
        /// <summary>
        /// HardDiskId
        /// </summary>
        ...
        /// </param>
        public MdvrMemoryCardErrorAlert(string str)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(str))
                {
                    ...
                    if (alertArray[3].Trim().ToUpper().Equals("V69"))
                    {
                        ...
                        //AlertType
                        this.AlertType = (short)DeviceAlertType.SdFault;
                        ...
                        //HardDiskId
                        this.HardDiskId = alertArray[38];
                        //ErrorCode
                        this.ErrorCode = alertArray[39];
                        //ErrorMessage
                        this.ErrorMessage = alertArray[40];
                    }
                }
            }
            catch (Exception ex)
            {
                Console.WriteLine(DateTime.Now + "--Gsafety.Ant.Alert.Contract.Data.MdvrMemoryCardErrorAlert.MdvrMemoryCardErrorAlert(string str) --" + ex.ToString());
            }
        }

        public MdvrMemoryCardErrorAlert() { }
    }
}
