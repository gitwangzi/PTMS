...
/////======================================================================
/////                   Guid: c9306595-2ef1-449e-a217-1f6d423d93d9      
...
/////            Create Time: 8/26/2013 10:34:59 AM
/////      Class Description:  
/////======================================================================
/////          Modified Time: 8/26/2013 10:34:59 AM
/////            Modified by:
...
namespace Gsafety.PTMS.Message.Contract.Data
{
    ...
    [Serializable]
    [DataContract]
    public class TemperatureAlert : AlertBaseModel
    {

        /// <summary>
        /// Temperature Type
        /// "0"Security Suite Temperature;"1"Engine Temperature;"2"Vehicle Temperature
        /// </summary>
        [DataMember]
        public Int16 TemperatureType { get; set; }
        ...
        /// </param>
        public TemperatureAlert(string str)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(str))
                {
                    ...
                    if (alertArray[3].Trim().ToUpper().Equals("V68"))
                    {
                        ...
                        //Temperature Type
                        this.TemperatureType = Convert.ToInt16(alertArray[38]);
                        //Current Temperature
                        this.CurrentTemperature = alertArray[39];
                        //Min Temperature
                        this.MinTemperature = alertArray[40];
                        //Max Temperature
                        this.MaxTemperature = alertArray[41];
                        //Alert Type

                        //Update Bug 5227----by xiay
                        if (int.Parse(alertArray[43]) % 2 == 0)
                        {
                            this.AlertType = (short)DeviceAlertType.LowTemperature;
                        }
                        else
                        {
                            this.AlertType = (short)DeviceAlertType.OverTemperature;
                        }
                    }
                }
            }
            ...
            {
                Console.WriteLine(DateTime.Now + "--Gsafety.Ant.Alert.Contract.Data.TemperatureAlert.TemperatureAlert(string str) --" + ex.ToString());
            }
        }
