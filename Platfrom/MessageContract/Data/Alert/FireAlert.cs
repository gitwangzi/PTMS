...
/////======================================================================
/////                   Guid: 1d4c367a-14e6-4a59-b4e9-522f1b22b0ff      
...
/////    Project Description:    
/////             Class Name: FireAlert
/////          Class Version: v1.0.0.0
/////            Create Time: 8/28/2013 1:32:25 PM
/////      Class Description:  
/////======================================================================
/////          Modified Time: 8/28/2013 1:32:25 PM
/////            Modified by:
...
namespace Gsafety.PTMS.Message.Contract.Data
{
    ...
    [Serializable]
    [DataContract]
    public class FireAlert : AlertBaseModel
    {
        /// <summary>
        /// FireType。
        /// 0:MisFire By Exception;1:Start Fire
        /// </summary>
        [DataMember]
        public short FireType { get; set; }
        ...
        public FireAlert(string str)
        {
            ...
            try
            {
                if (!string.IsNullOrEmpty(str))
                {
                    ...
                    {
                        if (alertArray[3].Trim().ToUpper().Equals("V82"))
                        {
                            ...
                            //AlertType
                            this.AlertType = (short)DeviceAlertType.AbnormalFire;
                            ...
                            //FireType
                            this.FireType = Convert.ToInt16(alertArray[38]);
                            //TimeZone
                            this.TimeZone = alertArray[39];
                        }
                    }
                }
            }
            ...
            {
                Console.WriteLine(DateTime.Now + "--Gsafety.Ant.Alert.Contract.Data.FireAlert.FireAlert(string str) --" + ex.ToString());
            }
        }
